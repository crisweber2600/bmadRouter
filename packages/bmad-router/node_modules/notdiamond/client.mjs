...
import { CustomRouter, } from "./resources/custom-router.mjs";
import { ModelRouter, } from "./resources/model-router.mjs";
import { Models } from "./resources/models.mjs";
import { Preferences, } from "./resources/preferences.mjs";
import { PromptOptimization, } from "./resources/prompt-optimization.mjs";
...
export class NotDiamond {
    ...
    constructor({ baseURL = readEnv('NOTDIAMOND_BASE_URL'), apiKey = readEnv('NOT_DIAMOND_API_KEY'), ...opts } = {}) {
        ...
        this.promptOptimization = new API.PromptOptimization(this);
